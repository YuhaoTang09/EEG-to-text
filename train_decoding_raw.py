...
if __name__ == '__main__':
    ...
    if 'task1' in task_name:
        dataset_path_task1 = 'F:/dataset/ZuCo/task1-SR/pickle/task1-SR-dataset_wRaw.pickle'
        with open(dataset_path_task1, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task2' in task_name:
        dataset_path_task2 = 'F:/dataset/ZuCo/task2-NR/pickle/task2-NR-dataset_wRaw.pickle'
        with open(dataset_path_task2, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task3' in task_name:
        dataset_path_task3 = 'F:/dataset/ZuCo/task3-TSR/pickle/task3-TSR-dataset_wRaw.pickle'
        with open(dataset_path_task3, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    '''if 'taskNRv2' in task_name:
        dataset_path_taskNRv2 = 'F:/dataset/ZuCo/task2-NR-2.0/pickle/task2-NR-2.0-dataset_wRaw.pickle'
    ...
    if model_name in ['BrainTranslator', 'BrainTranslatorNaive']:
        ...
        tokenizer = BartTokenizer.from_pretrained('./models/facebook/bart-large')
    # train dataset
